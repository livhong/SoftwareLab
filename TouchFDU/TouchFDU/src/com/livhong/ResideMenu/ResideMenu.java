package com.livhong.ResideMenu;
...
public class ResideMenu extends FrameLayout{
    ...
    public void setSwipeDirecionAble(int direction){
    	Iterator<Integer> it = disabledSwipeDirection.iterator();
    	while(it.hasNext()){
    		if(it.next()==direction)
    			it.remove();
    	}
//    	int size = disabledSwipeDirection.size();
//    	for(int i = 0; i < size; i++){
//    		if(disabledSwipeDirection.get(i)==direction){
//    			disabledSwipeDirection.remove(i);
//    		}
//    	}
    }
